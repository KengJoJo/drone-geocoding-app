...
def load_whisper_model():
    ...
    # ลำดับ priority: medium -> base (เพื่อ compatibility บน cloud)
    models_to_try = [
...
def transcribe_audio(audio_bytes, model):
    ...
    try:
        ...
        segments, info = model.transcribe(
            ...
            beam_size=5,                # ลดลงเพื่อ performance บน cloud
            best_of=5,                  # ลดลงเพื่อ performance
            temperature=0.0,            # ความมั่นใจสูงสุด
            patience=1,                 # ลดลงเพื่อ performance
